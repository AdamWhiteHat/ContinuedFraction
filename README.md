...
A continued fraction class. Takes doubles, fractions or string representations of a long decimal number. Arbitrary precision supported. Supports converting a continued fraction into rational approximations up to precision, typically limited by the length of the decimal digit representation of the input.
